...
@Component({
    ...
    imports: [
      ...
      NayaEditPageComponent,
      UserConnectionTableComponent, 
...
export class UserConnectionEditPageComponent implements OnInit {
  ...
  public NSPageTitle = ConstantString.NayaConnections.getDisplayName();
  public NSEnvironmentName: string = String.empty;
